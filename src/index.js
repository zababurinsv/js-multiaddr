 ...
 * @returns {String} option.family - The address family name
 * @returns {String} option.host - The host part of the address
 * @returns {String} option.transport - Which transport the address uses
 * @returns {String} option.port - Which port the address uses
 * @example
 ...
 *
 * @returns {Object} nodeAddress
 * @returns {String} nodeAddress.family
 * @returns {String} nodeAddress.address
 * @returns {String} nodeAddress.port
 ...
 *
 * @instance
 * @returns {Object} protocols
 * @returns {Array} protocols.table
 * @returns {Object} protocols.names
 * @returns {Object} protocols.codes
 * protocols
 *
 */
